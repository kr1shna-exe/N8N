      ...
      <SidebarContent className="bg-sidebar border-r border-sidebar-border">
        ...
        <div className="p-4 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            {!isCollapsed && (
              <span className="text-sidebar-foreground font-semibold">n8n</span>
            )}
          </div>
        </div>
        ...
        <SidebarGroup>
          <div className="px-3 py-2">
            ...
            <button className="w-full mt-2 px-3 py-2 text-left text-sm bg-sidebar-accent rounded-md hover:bg-sidebar-accent/80 transition-colors">
              {!isCollapsed ? (
                <span className="text-sidebar-accent-foreground">+ Add project</span>
              ) : (
                <span className="text-sidebar-accent-foreground text-lg">+</span>
              )}
            </button>
          </div>
          <SidebarGroupContent>
